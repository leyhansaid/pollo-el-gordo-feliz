...
export const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className={`fixed z-50 bottom-5 left-5 md:left-auto md:right-6 md:bottom-6 transition-all duration-500 ${
        visible
          ? "opacity-100 translate-y-0"
          : "opacity-0 translate-y-4 pointer-events-none"
      }`}
    >
      <span className="relative inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1EBA57] text-white pl-3 pr-5 py-3 rounded-full shadow-[0_12px_40px_-8px_rgba(37,211,102,0.65)] wa-pulse">
        <span className="w-9 h-9 rounded-full bg-white/15 grid place-content-center">
